      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center text-sm">
          ...
          <p className="mb-2">
            ...
            <span className="text-cyan-400 font-semibold">ChatGPT</span> and
        ...
        <div className="mt-4 flex justify-center items-center space-x-6">
          ...
          >
            <svg
              ...
              className="w-6 h-6 text-cyan-400 hover:text-white transition duration-300"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <path
        ...
        <div className="text-gray-600 text-xs mt-4 text-center">
          &copy; {new Date().getFullYear()} Leonard Christopher. All rights reserved.
        </div>
      </div>
    </footer>
  );
